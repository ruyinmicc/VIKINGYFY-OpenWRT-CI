...
UPDATE_PACKAGE "easytier" "EasyTier/luci-app-easytier" "v2.6.4"
...
UPDATE_PACKAGE "luci-app-oaf" "destan19/OpenAppFilter" "v6.1.8"
UPDATE_PACKAGE "appfilter" "destan19/OpenAppFilter" "v6.1.8"
UPDATE_PACKAGE "open-app-filter" "destan19/OpenAppFilter" "v6.1.8"
...
UPDATE_PACKAGE  "luci-app-apfree-wifidog" "liudf0716/luci-app-apfree-wifidog"  "main"
UPDATE_PACKAGE  "apfree-wifidog" "liudf0716/apfree-wifidog" "main"
#更新软件包版本
UPDATE_VERSION() {
	local PKG_NAME=$1
